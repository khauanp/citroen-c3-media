#!/usr/bin/env python3
"""Verify the playlist-hardened 1.8.23 source and K00E runtime before packaging."""
...
def main() -> int:
    ...
    require(
        audio,
        "NETWORK_CUSHION_MS = 2_000",
        "configuredCodec",
        "invalid_format_ignored",
        "CODEC_AAC_ELD = 8",
        "true,\n                false,",
    )
    ...
    print("PASS: 1.8.23 playlist hardening, report export and verified K00E audio stack")
    return 0
