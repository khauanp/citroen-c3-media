...
def main() -> int:
    if len(sys.argv) != 3:
        raise SystemExit(
            "usage: verify_android_1_8_17_webview.py REFERENCE_1816 REBUILT_1817"
        )
    ...
    if "versionCode: 10817" not in config or "versionName: 1.8.17" not in config:
        raise RuntimeError("rebuilt APK does not report 1.8.17")
